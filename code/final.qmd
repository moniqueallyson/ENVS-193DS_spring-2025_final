...
# make new object for model predictions
model_prediction <- ggpredict(mod2, 
                              terms = c("edge_distance [all]", "season")) # season 2016 and 2019
...
ggplot(model_df, 
  ...
  labs(
    ...
    title = "Swift Parrots predicted by Distance and Season"
  ) +
...
**Figure 1. Swift Parrots have higher likehood for box occupancy when close to forest edge:** 
