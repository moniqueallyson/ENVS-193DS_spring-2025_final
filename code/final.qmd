...
Part 1: Because we rejected the null hypothesis, we conclude that there is a statistically significant relationship between distance from headwater (km) and annual total nitrogen load (kg year⁻¹).
(p = 0.03, α = 0.05).
